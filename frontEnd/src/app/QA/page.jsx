  ...
  return (
    <>
      ...
      >
        ...
        <div className=" bg-[#1A53A0] md:p-4 lg:rounded-none shadow-[#1A53A0] shadow-sm text-white my-0.5 max-w-[70%] lg:max-w-[50%] rounded-sm">
          <h1 className="text-center font-pop1 text-3xl">ILO IFEANYI VICTOR</h1>
        </div>
        <div className="flex justify-center">
          <section className="mx-2 lg:flex lg:flex-col lg:max-w-[80%] justify-center">
            <ul className="hidden  lg:flex gap-5 ml-8 mt-2 font-pop2">
              <li className="border-[#1A53A0] border text-center flex items-center text-xs shadow-[#1A53A0] shadow-sm px-1 rounded-sm">
                Quality Assurance
              </li>
              <li className="border-[#1A53A0] border text-center flex items-center text-xs shadow-[#1A53A0] shadow-sm px-1 rounded-sm">
                Automation
            ...
            <section className="max-w-full   flex justify-center my-3">
              <div className=" flex md:gap-5 flex-col md:flex-row-reverse justify-center items-center">
                <div className="border-2 md:flex-1 border-[#1A53A0] mb-3 md:rounded-full md:bg-[#1A53A0] md:shadow-2xl rounded-full md:flex md:justify-center w-[50%] overflow-hidden">
                  <Image
                    src="/me.jpeg"
                    width={200}
                    height={40}
                ...
                <div className="md:flex-1 shadow md:shadow-lg md:p-4 md:rounded-sm bg-white opacity-85">
                  <p className="text-xs md:text-sm font-pop2  text-justify">
            ...
            <section>
              <div className="flex gap-2 mt-6 md:border lg:border-dashed md:max-w-[50%] justify-center items-center">
                ...
                <div className="bg-[#1A53A0] md:p-3  flex-3 p-0.2">
              ...
              <div className="my-2">
                <button className="border-[#1A53A0] border shadow-[#1A53A0] shadow-sm px-0.5 rounded-lg text-xs font-pop2 mx-2">
                  PlayWright
                </button>
                <button className="border-[#1A53A0] border shadow-[#1A53A0] shadow-sm px-0.5 rounded-lg text-xs font-pop2 mx-2">
                  Github Actions
            ...
            <section>
              <div className=" bg-[#1A53A0] text-white md:mt-8  max-w-[70%] mt-8 ">
              ...
              <div className="flex shadow-sm mt-5 mb-5 md:gap-10 justify-center gap-4 p-1">
                ...
                <div className=" max-w-[50%]">
                  ...
                  <ul className="font-pop2 text-xs md:text-sm">
                    ...
                    <li>javascript Automated scripts</li>
                    <li>Python Automated scripts</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            >
              <div className="bg-[#1A53A0] mb-5">
                <h1 className="font-pop1 md:p-3 text-white text-center p-1">
                  TESTING PROJECTS
                </h1>
              </div>
              <div className="flex justify-center">
                <div className="border md:rounded-none opacity-90 lg:m-3 md:bg-white md:border-none md:shadow-xl border-[#1A53A0] md:max-w-[70%] rounded-2xl p-1">
                  ...
                  <center>
                    ...
                    <h1 className="mt-4">Its demo time!!!</h1>
                  ...
                  <div className="shadow-sm mt-5">
                    ...
                    <div className="text-sm">
                      ...
                      <div className="lg:mt-3 ">
                        <div className="max-w-full border border-amber-600 flex justify-center">
